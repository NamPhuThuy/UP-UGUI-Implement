...
namespace NamPhuThuy.UGUIImplement
{
    ...
    public class GUIGallery : GUIBase
    {
        ...
        /// </summary>
        public event Action<List<AlbumRecord>> OnGalleryListChanged;
        ...
        public struct FilterChoice
        {
            ...
            public FilterChoice(FilterKind kind, PictureStyle style, PictureRarity rarity, AlbumData.LikeState likeState)
            {
                Kind = kind;
                Style = style;
                Rarity = rarity;
        ...
        private List<AlbumRecord> _workingList = new List<AlbumRecord>();
        ...
        void OnEnable()
        {
            ...
            currentFilterChoice = new FilterChoice(FilterKind.All, PictureStyle.ANIME, PictureRarity.NORMAL, AlbumData.LikeState.NONE);
        ...
        private IEnumerator IEInit()
        {
            ...
            currentFilterChoice.Rarity = PictureRarity.NORMAL;

            // NEW
            ScrollTheViewToTop();

            currentPictureIdList = scrollViewGallery.UpdateContent(currentFilterChoice);
        }
        #endregion
        ...
        private void OnClickConfirmFilter()
        {
            ...
            currentPictureIdList = scrollViewGallery.UpdateContent(currentFilterChoice);
            if (currentPictureIdList == null || currentPictureIdList.Count < 1)
            {
                var args = new ToastArgs
                {
                    message = LeanLocalization.GetTranslationText(LeanLocalizedConst.NO_PICTURE),
                    customAnchoredPos = AnimationConst.UPPER_MIDDLE_ANCHORED_POS,
            ...
            TweenHelper.HideDropdown(_filterView, _filterViewCanvasGroup);
        }
        ...
        private void OnClickSpecialFilter()
        {
            ...
            currentFilterChoice.Rarity = PictureRarity.SPECIAL;
        ...
        private void OnClickToggleFilterView()
        {
            ...
            switch (buttonState)
            {
                ...
                case ButtonSwitch.ButtonSwitchState.OFF:
                    ...
                    TweenHelper.OpenDropdown(_filterView, _filterViewCanvasGroup);
                    break;
            }
        }
        ...
        private void OnClickLikeStateLike()
        {
            ...
            currentFilterChoice.LikeState = AlbumData.LikeState.LIKE;
        ...
        private void OnClickLikeStateDislike()
        {
            ...
            currentFilterChoice.LikeState = AlbumData.LikeState.DISLIKE;
            currentFilterChoice.Kind = FilterKind.LikeState;
        }
        ...
        private void OnClickStyleAnime()
        {
            ...
            currentFilterChoice.Style = PictureStyle.ANIME;
        ...
        private void OnClickStyleSexy()
        {
            ...
            currentFilterChoice.Style = PictureStyle.SEXY;
            currentFilterChoice.Kind = FilterKind.Style;
        }
        ...
        private void OnClickStyleUniform()
        {
            ...
            currentFilterChoice.Style = PictureStyle.UNIFORM;
            currentFilterChoice.Kind = FilterKind.Style;
        }
        ...
        {
            if (_sortAscending)
                _workingList = _workingList.OrderBy(p => p.recordId).ToList();
            else
                _workingList = _workingList.OrderByDescending(p => p.recordId).ToList();
        }
