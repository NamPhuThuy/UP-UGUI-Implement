...
namespace NamPhuThuy
{
    ...
    public class GUIOfferHeart : MonoBehaviour
    {
    ...
    /*#if UNITY_EDITOR
    [CustomEditor(typeof(GUIOfferHeart))]
    [CanEditMultipleObjects]
    public class GUIOfferHeartEditor : Editor
    {
        private GUIOfferHeart script;
