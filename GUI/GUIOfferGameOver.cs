...
namespace NamPhuThuy
{
    ...
    public class GUIOfferGameOver : MonoBehaviour
    {
    ...
    /*#if UNITY_EDITOR
    [CustomEditor(typeof(GUIOfferGameOver))]
    [CanEditMultipleObjects]
    public class GUIOfferGameOverEditor : Editor
    {
        private GUIOfferGameOver script;
        ...
        public override void OnInspectorGUI()
        {
            ...
            script = (GUIOfferGameOver)target;
