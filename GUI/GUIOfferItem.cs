...
namespace NamPhuThuy
{
    ...
    public class GUIOfferItem : MonoBehaviour
    {
    ...
    /*#if UNITY_EDITOR
    [CustomEditor(typeof(GUIOfferItem))]
    [CanEditMultipleObjects]
    public class GUIOfferItemEditor : Editor
    {
        private GUIOfferItem script;
